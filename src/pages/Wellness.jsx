...
const Wellness = () => {
  return (
    <div
      className="flex justify-between flex-col screen5:flex-row px-[2rem] screen3:px-[5rem] screen6:px-[9rem] text-dark"
      id="wellness"
    >
      <div className="flex flex-col items-center screen5:items-start justify-center px-8 mt-6">
