...
const HeroHeading = () => {
  return (
    <div className="absolute left-[2rem] screen1:left-[5rem] top-[3rem] screen1:top-[5rem]  screen3:top-[8rem] screen4:top-32 screen7:left-36 screen5:top-40 text-light">
      <p className="text-[.5rem] screen2:text-[.8rem] screen6:text-lg text-accLight font-semibold ">
        It's Time For
      </p>
      <h1 className="text-[.8rem] screen1:text-[1rem] screen4:text-[2rem] screen7:text-[4rem] font-bold">
        Your Mountain<br></br>Escape
      </h1>
      <p className="text-[.5rem] screen4:text-sm hidden screen2:block">
